									...
									<table id="table-product" class="table table-bordered table-striped table-condensed table-center">
										...
										<tbody>
											<tr>
												...
												<td><input type="text" id="nilai_semen" name="nilai_semen" class="form-control numberformat text-center" value="" required="" autocomplete="off"></td>
											</tr>
											<tr>
												<td>2.</td>
												<td>Pasir</td>
												...
												<td><input type="text" id="nilai_pasir" name="nilai_pasir" class="form-control numberformat text-center" value="" required="" autocomplete="off"></td>
											</tr>
											<tr>
												<td>3.</td>
												...
												<td><input type="text" id="nilai_1020" name="nilai_1020" class="form-control numberformat text-center" value="" required="" autocomplete="off"></td>
											</tr>
											<tr>
												<td>4.</td>
												...
												<td><input type="text" id="nilai_2030" name="nilai_2030" class="form-control numberformat text-center" value="" required="" autocomplete="off"></td>
											</tr>
											<tr>
												<td>5.</td>
												<td>Additive</td>
												...
												<td><input type="text" id="nilai_additive" name="nilai_additive" class="form-control numberformat text-center" value="" required="" autocomplete="off"></td>
											</tr>
											<tr>
												<td>6.</td>
												<td>Solar</td>
												...
												<td><input type="text" id="nilai_solar" name="nilai_solar" class="form-control numberformat text-center" value="" required="" autocomplete="off"></td>
											</tr>
										</tbody>
										<tfoot>
										</tfoot>
