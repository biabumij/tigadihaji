	...
	<body>
		...
		<?php
			...
			<tr class="table-baris1">
				...
				<th align="right" style="border-right:1px solid black;"><?php echo number_format($total_produksi_nilai,0,',','.');?></th>
	        </tr>
			<tr class="table-total">		
				...
				<th align="right" style="background-color:#FFFF00; border-top:1px solid black; border-bottom:1px solid black;"></th>
				<th align="right" style="background-color:#FFFF00; border-top:1px solid black; border-bottom:1px solid black; border-right:1px solid black;"><?php echo number_format($total_nilai_realisasi,0,',','.');?></th>
	        </tr>
	    </table>
