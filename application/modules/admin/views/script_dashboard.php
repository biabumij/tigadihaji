...
//APRIL25
$rak_april25 = $this->db->select('*')
->from('rak')
->where("(tanggal_rencana_kerja between '$date_april25_awal' and '$date_april25_akhir')")
->get()->row_array();
$nilai_produk_a_april25 = $rak_april25['vol_produk_a'] * $rak_april25['price_a'];
$nilai_produk_b_april25 = $rak_april25['vol_produk_b'] * $rak_april25['price_b'];
$nilai_produk_c_april25 = $rak_april25['vol_produk_c'] * $rak_april25['price_c'];
$nilai_produk_d_april25 = $rak_april25['vol_produk_d'] * $rak_april25['price_d'];
$nilai_produk_e_april25 = $rak_april25['vol_produk_e'] * $rak_april25['price_e'];
$nilai_produk_f_april25 = $rak_april25['vol_produk_f'] * $rak_april25['price_f'];
$nilai_rak_penjualan_april25 = $nilai_produk_a_april25 + $nilai_produk_b_april25 + $nilai_produk_c_april25 + $nilai_produk_d_april25 + $nilai_produk_e_april25 + $nilai_produk_f_april25;
...
$total_presentase_rak_april25 = $total_rak_april25 / $nilai_rak_penjualan_april25;
...
//MEI25
$rak_mei25 = $this->db->select('*')
->from('rak')
->where("(tanggal_rencana_kerja between '$date_mei25_awal' and '$date_mei25_akhir')")
->get()->row_array();
$nilai_produk_a_mei25 = $rak_mei25['vol_produk_a'] * $rak_mei25['price_a'];
$nilai_produk_b_mei25 = $rak_mei25['vol_produk_b'] * $rak_mei25['price_b'];
$nilai_produk_c_mei25 = $rak_mei25['vol_produk_c'] * $rak_mei25['price_c'];
$nilai_produk_d_mei25 = $rak_mei25['vol_produk_d'] * $rak_mei25['price_d'];
$nilai_produk_e_mei25 = $rak_mei25['vol_produk_e'] * $rak_mei25['price_e'];
$nilai_produk_f_mei25 = $rak_mei25['vol_produk_f'] * $rak_mei25['price_f'];
$nilai_rak_penjualan_mei25 = $nilai_produk_a_mei25 + $nilai_produk_b_mei25 + $nilai_produk_c_mei25 + $nilai_produk_d_mei25 + $nilai_produk_e_mei25 + $nilai_produk_f_mei25;
...
$total_presentase_rak_mei25 = $total_rak_mei25 / $nilai_rak_penjualan_mei25;
...
//JUNI25
$rak_juni25 = $this->db->select('*')
->from('rak')
->where("(tanggal_rencana_kerja between '$date_juni25_awal' and '$date_juni25_akhir')")
->get()->row_array();
$nilai_produk_a_juni25 = $rak_juni25['vol_produk_a'] * $rak_juni25['price_a'];
$nilai_produk_b_juni25 = $rak_juni25['vol_produk_b'] * $rak_juni25['price_b'];
$nilai_produk_c_juni25 = $rak_juni25['vol_produk_c'] * $rak_juni25['price_c'];
$nilai_produk_d_juni25 = $rak_juni25['vol_produk_d'] * $rak_juni25['price_d'];
$nilai_produk_e_juni25 = $rak_juni25['vol_produk_e'] * $rak_juni25['price_e'];
$nilai_produk_f_juni25 = $rak_juni25['vol_produk_f'] * $rak_juni25['price_f'];
$nilai_rak_penjualan_juni25 = $nilai_produk_a_juni25 + $nilai_produk_b_juni25 + $nilai_produk_c_juni25 + $nilai_produk_d_juni25 + $nilai_produk_e_juni25 + $nilai_produk_f_juni25;
...
$total_presentase_rak_juni25 = $total_rak_juni25 / $nilai_rak_penjualan_juni25;
