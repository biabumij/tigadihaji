...
//JANUARI26
$rak_januari26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_januari26_awal' and '$date_januari26_akhir'")
->get()->row_array();
$rencana_produksi_januari26 = $rak_januari26['total_produksi'];
...
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_januari26 = 0;
foreach ($penjualan_januari26 as $x){
    $total_volume_penjualan_januari26 += $x['volume'];
}
$realisasi_produksi_januari26 = $total_volume_penjualan_januari26;

//FEBRUARI26
$rak_februari26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_februari26_awal' and '$date_februari26_akhir'")
->get()->row_array();
$rencana_produksi_februari26 = $rak_februari26['total_produksi'];

$penjualan_februari26 = $this->db->select('p.nama, pp.client_id, SUM(pp.display_price) as price, SUM(pp.display_volume) as volume, pp.convert_measure as measure')
->from('pmm_productions pp')
->join('penerima p', 'pp.client_id = p.id','left')
->join('pmm_sales_po ppo', 'pp.salesPo_id = ppo.id','left')
->where("pp.date_production between '$date_februari26_awal' and '$date_februari26_akhir'")
->where("pp.status = 'PUBLISH'")
->where("ppo.status in ('OPEN','CLOSED')")
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_februari26 = 0;
foreach ($penjualan_februari26 as $x){
    $total_volume_penjualan_februari26 += $x['volume'];
}
$realisasi_produksi_februari26 = $total_volume_penjualan_februari26;

//MARET26
$rak_maret26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_maret26_awal' and '$date_maret26_akhir'")
->get()->row_array();
$rencana_produksi_maret26 = $rak_maret26['total_produksi'];

$penjualan_maret26 = $this->db->select('p.nama, pp.client_id, SUM(pp.display_price) as price, SUM(pp.display_volume) as volume, pp.convert_measure as measure')
->from('pmm_productions pp')
->join('penerima p', 'pp.client_id = p.id','left')
->join('pmm_sales_po ppo', 'pp.salesPo_id = ppo.id','left')
->where("pp.date_production between '$date_maret26_awal' and '$date_maret26_akhir'")
->where("pp.status = 'PUBLISH'")
->where("ppo.status in ('OPEN','CLOSED')")
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_maret26 = 0;
foreach ($penjualan_maret26 as $x){
    $total_volume_penjualan_maret26 += $x['volume'];
}
$realisasi_produksi_maret26 = $total_volume_penjualan_maret26;

//APRIL26
$rak_april26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_april26_awal' and '$date_april26_akhir'")
->get()->row_array();
$rencana_produksi_april26 = $rak_april26['total_produksi'];
...
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_april26 = 0;
foreach ($penjualan_april26 as $x){
    $total_volume_penjualan_april26 += $x['volume'];
}
$realisasi_produksi_april26 = $total_volume_penjualan_april26;

//MEI26
$rak_mei26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_mei26_awal' and '$date_mei26_akhir'")
->get()->row_array();
$rencana_produksi_mei26 = $rak_mei26['total_produksi'];
...
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_mei26 = 0;
foreach ($penjualan_mei26 as $x){
    $total_volume_penjualan_mei26 += $x['volume'];
}
$realisasi_produksi_mei26 = $total_volume_penjualan_mei26;

//JUNI26
$rak_juni26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_juni26_awal' and '$date_juni26_akhir'")
->get()->row_array();
$rencana_produksi_juni26 = $rak_juni26['total_produksi'];
...
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_juni26 = 0;
foreach ($penjualan_juni26 as $x){
    $total_volume_penjualan_juni26 += $x['volume'];
}
$realisasi_produksi_juni26 = $total_volume_penjualan_juni26;

//JULI26
$rak_juli26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_juli26_awal' and '$date_juli26_akhir'")
->get()->row_array();
$rencana_produksi_juli26 = $rak_juli26['total_produksi'];
...
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_juli26 = 0;
foreach ($penjualan_juli26 as $x){
    $total_volume_penjualan_juli26 += $x['volume'];
}
$realisasi_produksi_juli26 = $total_volume_penjualan_juli26;

//AGUSTUS26
$rak_agustus26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_agustus26_awal' and '$date_agustus26_akhir'")
->get()->row_array();
$rencana_produksi_agustus26 = $rak_agustus26['total_produksi'];

$penjualan_agustus26 = $this->db->select('p.nama, pp.client_id, SUM(pp.display_price) as price, SUM(pp.display_volume) as volume, pp.convert_measure as measure')
->from('pmm_productions pp')
->join('penerima p', 'pp.client_id = p.id','left')
->join('pmm_sales_po ppo', 'pp.salesPo_id = ppo.id','left')
->where("pp.date_production between '$date_agustus26_awal' and '$date_agustus26_akhir'")
->where("pp.status = 'PUBLISH'")
->where("ppo.status in ('OPEN','CLOSED')")
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_agustus26 = 0;
foreach ($penjualan_agustus26 as $x){
    $total_volume_penjualan_agustus26 += $x['volume'];
}
$realisasi_produksi_agustus26 = $total_volume_penjualan_agustus26;

//SEPTEMBER26
$rak_september26 = $this->db->select('(r.vol_produk_a + r.vol_produk_b + r.vol_produk_c + r.vol_produk_d + r.vol_produk_e + r.vol_produk_f) as total_produksi')
->from('rak r')
->where("r.tanggal_rencana_kerja between '$date_september26_awal' and '$date_september26_akhir'")
->get()->row_array();
$rencana_produksi_september26 = $rak_september26['total_produksi'];

$penjualan_september26 = $this->db->select('p.nama, pp.client_id, SUM(pp.display_price) as price, SUM(pp.display_volume) as volume, pp.convert_measure as measure')
->from('pmm_productions pp')
->join('penerima p', 'pp.client_id = p.id','left')
->join('pmm_sales_po ppo', 'pp.salesPo_id = ppo.id','left')
->where("pp.date_production between '$date_september26_awal' and '$date_september26_akhir'")
->where("pp.status = 'PUBLISH'")
->where("ppo.status in ('OPEN','CLOSED')")
->group_by("pp.client_id")
->get()->result_array();
$total_volume_penjualan_september26 = 0;
foreach ($penjualan_september26 as $x){
    $total_volume_penjualan_september26 += $x['volume'];
}
...
//FEBRUARI26
$total_niai_komposisi_bahan_februari26 = $this->pmm_model->getKomposisiBahan($date_februari26_awal,$date_februari26_akhir);
$total_niai_komposisi_alat_februari26 = $this->pmm_model->getKomposisiAlat($date_februari26_awal,$date_februari26_akhir);
$total_niai_komposisi_bua_februari26 = $this->pmm_model->getKomposisiBUA($date_februari26_awal,$date_februari26_akhir);
$total_rak_februari26 = $total_niai_komposisi_bahan_februari26 + $total_niai_komposisi_alat_februari26 + $total_niai_komposisi_bua_februari26;
...
->group_by("pp.client_id")
->get()->result_array();
$total_penjualan_februari26 = 0;
foreach ($penjualan_februari26 as $x){
    $total_penjualan_februari26 += $x['price'];
}

$rak_laba_rugi_februari26 = $total_penjualan_februari26 - $total_rak_februari26;
$total_presentase_rak_februari26 = ($total_penjualan_februari26!=0)?($rak_laba_rugi_februari26 / $total_penjualan_februari26) * 100:0;
$persentase_rak_februari26 = round($total_presentase_rak_februari26,2);

$date1 = $date_februari26_awal;
$date2 = $date_februari26_akhir;
$bahan_februari26 = $this->pmm_model->getBahan($date_februari26_awal,$date_februari26_akhir);
$alat_februari26 = $this->pmm_model->getAlat($date_februari26_awal,$date_februari26_akhir);
$overhead_februari26 = $this->pmm_model->getOverheadLabaRugi($date_februari26_awal,$date_februari26_akhir);
$diskonto_februari26 = $this->db->select('sum(pdb.jumlah) as total')
->from('pmm_biaya pb ')
->join('pmm_detail_biaya pdb','pb.id = pdb.biaya_id','left')
->join('pmm_coa c','pdb.akun = c.id','left')
->where("pdb.akun = 110")
->where("pb.status = 'PAID'")
->where("(pb.tanggal_transaksi between '$date_februari26_awal' and '$date_februari26_akhir')")
->get()->row_array();
$diskonto_februari26 = $diskonto_februari26['total'];
$laba_rugi_februari26 = $total_penjualan_februari26 - ($bahan_februari26 + $alat_februari26 + $overhead_februari26 + $diskonto_februari26);
$total_laba_rugi_februari26 = ($total_penjualan_februari26!=0)?($laba_rugi_februari26 / $total_penjualan_februari26) * 100:0;
$persentase_laba_rugi_februari26 = round($total_laba_rugi_februari26,2);

//MARET26
$total_niai_komposisi_bahan_maret26 = $this->pmm_model->getKomposisiBahan($date_maret26_awal,$date_maret26_akhir);
$total_niai_komposisi_alat_maret26 = $this->pmm_model->getKomposisiAlat($date_maret26_awal,$date_maret26_akhir);
$total_niai_komposisi_bua_maret26 = $this->pmm_model->getKomposisiBUA($date_maret26_awal,$date_maret26_akhir);
$total_rak_maret26 = $total_niai_komposisi_bahan_maret26 + $total_niai_komposisi_alat_maret26 + $total_niai_komposisi_bua_maret26;
...
->group_by("pp.client_id")
->get()->result_array();
$total_penjualan_maret26 = 0;
foreach ($penjualan_maret26 as $x){
    $total_penjualan_maret26 += $x['price'];
}

$rak_laba_rugi_maret26 = $total_penjualan_maret26 - $total_rak_maret26;
$total_presentase_rak_maret26 = ($total_penjualan_maret26!=0)?($rak_laba_rugi_maret26 / $total_penjualan_maret26) * 100:0;
$persentase_rak_maret26 = round($total_presentase_rak_maret26,2);

$date1 = $date_maret26_awal;
$date2 = $date_maret26_akhir;
$bahan_maret26 = $this->pmm_model->getBahan($date_maret26_awal,$date_maret26_akhir);
$alat_maret26 = $this->pmm_model->getAlat($date_maret26_awal,$date_maret26_akhir);
$overhead_maret26 = $this->pmm_model->getOverheadLabaRugi($date_maret26_awal,$date_maret26_akhir);
$diskonto_maret26 = $this->db->select('sum(pdb.jumlah) as total')
->from('pmm_biaya pb ')
->join('pmm_detail_biaya pdb','pb.id = pdb.biaya_id','left')
->join('pmm_coa c','pdb.akun = c.id','left')
->where("pdb.akun = 110")
->where("pb.status = 'PAID'")
->where("(pb.tanggal_transaksi between '$date_maret26_awal' and '$date_maret26_akhir')")
->get()->row_array();
$diskonto_maret26 = $diskonto_maret26['total'];
$laba_rugi_maret26 = $total_penjualan_maret26 - ($bahan_maret26 + $alat_maret26 + $overhead_maret26 + $diskonto_maret26);
...
//AGUSTUS26
$total_niai_komposisi_bahan_agustus26 = $this->pmm_model->getKomposisiBahan($date_agustus26_awal,$date_agustus26_akhir);
$total_niai_komposisi_alat_agustus26 = $this->pmm_model->getKomposisiAlat($date_agustus26_awal,$date_agustus26_akhir);
$total_niai_komposisi_bua_agustus26 = $this->pmm_model->getKomposisiBUA($date_agustus26_awal,$date_agustus26_akhir);
$total_rak_agustus26 = $total_niai_komposisi_bahan_agustus26 + $total_niai_komposisi_alat_agustus26 + $total_niai_komposisi_bua_agustus26;
...
->group_by("pp.client_id")
->get()->result_array();
$total_penjualan_agustus26 = 0;
foreach ($penjualan_agustus26 as $x){
    $total_penjualan_agustus26 += $x['price'];
}

$rak_laba_rugi_agustus26 = $total_penjualan_agustus26 - $total_rak_agustus26;
$total_presentase_rak_agustus26 = ($total_penjualan_agustus26!=0)?($rak_laba_rugi_agustus26 / $total_penjualan_agustus26) * 100:0;
$persentase_rak_agustus26 = round($total_presentase_rak_agustus26,2);

$date1 = $date_agustus26_awal;
$date2 = $date_agustus26_akhir;
$bahan_agustus26 = $this->pmm_model->getBahan($date_agustus26_awal,$date_agustus26_akhir);
$alat_agustus26 = $this->pmm_model->getAlat($date_agustus26_awal,$date_agustus26_akhir);
$overhead_agustus26 = $this->pmm_model->getOverheadLabaRugi($date_agustus26_awal,$date_agustus26_akhir);
$diskonto_agustus26 = $this->db->select('sum(pdb.jumlah) as total')
->from('pmm_biaya pb ')
->join('pmm_detail_biaya pdb','pb.id = pdb.biaya_id','left')
->join('pmm_coa c','pdb.akun = c.id','left')
->where("pdb.akun = 110")
->where("pb.status = 'PAID'")
->where("(pb.tanggal_transaksi between '$date_agustus26_awal' and '$date_agustus26_akhir')")
->get()->row_array();
$diskonto_agustus26 = $diskonto_agustus26['total'];
$laba_rugi_agustus26 = $total_penjualan_agustus26 - ($bahan_agustus26 + $alat_agustus26 + $overhead_agustus26 + $diskonto_agustus26);
$total_laba_rugi_agustus26 = ($total_penjualan_agustus26!=0)?($laba_rugi_agustus26 / $total_penjualan_agustus26) * 100:0;
$persentase_laba_rugi_agustus26 = round($total_laba_rugi_agustus26,2);

//SEPTEMBER26
$total_niai_komposisi_bahan_september26 = $this->pmm_model->getKomposisiBahan($date_september26_awal,$date_september26_akhir);
$total_niai_komposisi_alat_september26 = $this->pmm_model->getKomposisiAlat($date_september26_awal,$date_september26_akhir);
$total_niai_komposisi_bua_september26 = $this->pmm_model->getKomposisiBUA($date_september26_awal,$date_september26_akhir);
$total_rak_september26 = $total_niai_komposisi_bahan_september26 + $total_niai_komposisi_alat_september26 + $total_niai_komposisi_bua_september26;
...
->group_by("pp.client_id")
->get()->result_array();
$total_penjualan_september26 = 0;
foreach ($penjualan_september26 as $x){
    $total_penjualan_september26 += $x['price'];
}

$rak_laba_rugi_september26 = $total_penjualan_september26 - $total_rak_september26;
$total_presentase_rak_september26 = ($total_penjualan_september26!=0)?($rak_laba_rugi_september26 / $total_penjualan_september26) * 100:0;
$persentase_rak_september26 = round($total_presentase_rak_september26,2);

$date1 = $date_september26_awal;
$date2 = $date_september26_akhir;
$bahan_september26 = $this->pmm_model->getBahan($date_september26_awal,$date_september26_akhir);
$alat_september26 = $this->pmm_model->getAlat($date_september26_awal,$date_september26_akhir);
$overhead_september26 = $this->pmm_model->getOverheadLabaRugi($date_september26_awal,$date_september26_akhir);
$diskonto_september26 = $this->db->select('sum(pdb.jumlah) as total')
->from('pmm_biaya pb ')
->join('pmm_detail_biaya pdb','pb.id = pdb.biaya_id','left')
->join('pmm_coa c','pdb.akun = c.id','left')
->where("pdb.akun = 110")
->where("pb.status = 'PAID'")
->where("(pb.tanggal_transaksi between '$date_september26_awal' and '$date_september26_akhir')")
->get()->row_array();
$diskonto_september26 = $diskonto_september26['total'];
$laba_rugi_september26 = $total_penjualan_september26 - ($bahan_september26 + $alat_september26 + $overhead_september26 + $diskonto_september26);
$total_laba_rugi_september26 = ($total_penjualan_september26!=0)?($laba_rugi_september26 / $total_penjualan_september26) * 100:0;
$persentase_laba_rugi_september26 = round($total_laba_rugi_september26,2);

//OKTOBER26
$total_niai_komposisi_bahan_oktober26 = $this->pmm_model->getKomposisiBahan($date_oktober26_awal,$date_oktober26_akhir);
$total_niai_komposisi_alat_oktober26 = $this->pmm_model->getKomposisiAlat($date_oktober26_awal,$date_oktober26_akhir);
$total_niai_komposisi_bua_oktober26 = $this->pmm_model->getKomposisiBUA($date_oktober26_awal,$date_oktober26_akhir);
$total_rak_oktober26 = $total_niai_komposisi_bahan_oktober26 + $total_niai_komposisi_alat_oktober26 + $total_niai_komposisi_bua_oktober26;
...
->group_by("pp.client_id")
->get()->result_array();
$total_penjualan_oktober26 = 0;
foreach ($penjualan_oktober26 as $x){
    $total_penjualan_oktober26 += $x['price'];
}

$rak_laba_rugi_oktober26 = $total_penjualan_oktober26 - $total_rak_oktober26;
$total_presentase_rak_oktober26 = ($total_penjualan_oktober26!=0)?($rak_laba_rugi_oktober26 / $total_penjualan_oktober26) * 100:0;
$persentase_rak_oktober26 = round($total_presentase_rak_oktober26,2);

$date1 = $date_oktober26_awal;
$date2 = $date_oktober26_akhir;
$bahan_oktober26 = $this->pmm_model->getBahan($date_oktober26_awal,$date_oktober26_akhir);
$alat_oktober26 = $this->pmm_model->getAlat($date_oktober26_awal,$date_oktober26_akhir);
$overhead_oktober26 = $this->pmm_model->getOverheadLabaRugi($date_oktober26_awal,$date_oktober26_akhir);
$diskonto_oktober26 = $this->db->select('sum(pdb.jumlah) as total')
->from('pmm_biaya pb ')
->join('pmm_detail_biaya pdb','pb.id = pdb.biaya_id','left')
->join('pmm_coa c','pdb.akun = c.id','left')
->where("pdb.akun = 110")
->where("pb.status = 'PAID'")
->where("(pb.tanggal_transaksi between '$date_oktober26_awal' and '$date_oktober26_akhir')")
->get()->row_array();
$diskonto_oktober26 = $diskonto_oktober26['total'];
$laba_rugi_oktober26 = $total_penjualan_oktober26 - ($bahan_oktober26 + $alat_oktober26 + $overhead_oktober26 + $diskonto_oktober26);
$total_laba_rugi_oktober26 = ($total_penjualan_oktober26!=0)?($laba_rugi_oktober26 / $total_penjualan_oktober26) * 100:0;
$persentase_laba_rugi_oktober26 = round($total_laba_rugi_oktober26,2);
