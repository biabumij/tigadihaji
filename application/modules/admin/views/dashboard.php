                    ...
                    chart = new Highcharts.Chart({
                        chart: {
                            ...
                            backgroundColor: {
                                ...
                                stops: [
                                    [0, 'rgb(105, 105, 105, 0.8)'],
                                    [1, 'rgb(105, 105, 105, 0.8)']
                                ]
                            },
                        },
                        title: {
                        ...
                        xAxis: { //data bulan
                            ...
                            categories: ['Februari 25','Maret 25','April 25','Mei 25','Juni 25','Juli 25','Agustus 25','September 25','Oktober 25','November 25','Desember 25','Januari 26','Februari 26','Maret 26','April 26','Mei 26','Juni 26','Juli 26','Agustus 26','September 26','Oktober 26']
                        },
                        yAxis: {
                            //title: {  //label yAxis
                        ...
                        series: [{  
                            ...
                            data: [<?php echo json_encode($rencana_produksi_februari25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_maret25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_april25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_mei25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_juni25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_juli25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_agustus25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_september25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_oktober25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_november25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_desember25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_januari26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_februari26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_maret26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_april26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_mei26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_juni26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_juli26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_agustus26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_september26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($rencana_produksi_oktober26, JSON_NUMERIC_CHECK); ?>],
                        ...
                        {  
                            ...
                            data: [<?php echo json_encode($realisasi_produksi_februari25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_maret25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_april25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_mei25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_juni25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_juli25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_agustus25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_september25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_oktober25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_november25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_desember25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_januari26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_februari26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_maret26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_april26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_mei26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_juni26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_juli26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_agustus26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_september26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($realisasi_produksi_oktober26, JSON_NUMERIC_CHECK); ?>],
                ...
                $(document).ready(function() {
                    chart = new Highcharts.Chart({
                        ...
                        xAxis: { //X axis menampilkan data bulan
                            ...
                            categories: ['Februari 25','Maret 25','April 25','Mei 25','Juni 25','Juli 25','Agustus 25','September 25','Oktober 25','November 25','Desember 25','Januari 26','Februari 26','Maret 26','April 26','Mei 26','Juni 26','Juli 26','Agustus 26','September 26']
                        },
                        yAxis: {
                            //title: {  //label yAxis
                                //text: 'RAP <br /><?php echo number_format(0,0,',','.'); ?>'
                        ...
                        series: [{  
                            name: 'L/R (RAP) %',  
                            data: [<?php echo json_encode($persentase_rak_februari25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_maret25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_april25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_mei25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_juni25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_juli25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_agustus25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_september25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_oktober25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_november25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_desember25, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_januari26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_februari26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_maret26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_april26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_mei26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_juni26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_juli26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_agustus26, JSON_NUMERIC_CHECK); ?>,<?php echo json_encode($persentase_rak_september26, JSON_NUMERIC_CHECK); ?>],
                            color: '#000000',
                            fontWeight: 'bold',
                            fontSize: '10px',
                            fontFamily: 'helvetica'
