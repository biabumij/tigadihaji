			...
			<tr class="table-active3">
				<th class="text-left" colspan="7">
					...
					<div>
						...
						?>
						<button onclick="myFunction16()" class="btn btn-info"><b>(5-50311) Bensin, Tol dan Parkir - Umum<b></button>
						...
						<div>
							<table width="100% "border="0">
								<tr>
									<th class="text-right" width="70%">(5-50311) Bensin, Tol dan Parkir - Umum | Saldo Akhir</th>
					...
					<div>
						...
						?>
						<button onclick="myFunction17()" class="btn btn-info"><b>(5-50314) Pakaian Dinas & K3<b></button>
						...
						<div>
							<table width="100% "border="0">
								<tr>
									<th class="text-right" width="70%">(5-50314) Pakaian Dinas & K3 | Saldo Akhir</th>
