                    ...
                    <div class="col-sm-12 col-lg-12">
                        ...
                        <div class="panel-content">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="#home_2" aria-controls="home_2" role="tab" data-toggle="tab" style="border-radius:10px 0px 10px 0px; font-weight:bold;">BIAYA BUA (<?php echo date('F');?>)</a></li>
                            </ul>
