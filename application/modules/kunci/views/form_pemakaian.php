				...
				<div class="col-sm-12 col-lg-12">
					<div class="panel">
						...
						<div class="panel-content">
							<form method="POST" action="<?php echo site_url('kunci/submit_pemakaian');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
								<div class="row">
									<div class="col-sm-2">
										<label>Tanggal</label>
									</div>
								...
								<br />
								<a href="<?= site_url('admin/kunci#pemakaian');?>" class="btn btn-danger" style="margin-bottom:0; font-weight:bold; border-radius:10px;">BATAL</a>
