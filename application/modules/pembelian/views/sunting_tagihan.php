                        ...
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="text-center">
                                    <a href="<?= site_url('pembelian/penagihan_pembelian_detail/'.$row['id']);?>" class="btn btn-info" style="width:10%; font-weight:bold; border-radius:5px;"> KEMBALI</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" style="padding: 0 10px 0 20px;" >
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success" id="btn-form" style="font-weight:bold; border-radius:5px;"><i class="fa fa-send"></i> Update Tagihan</button>
                        </div>
                    </form>
                </div>
